...
#+begin_example
src/demos/
├── mod.rs          # Registry and re-exports
├── template.rs     # Shared Profile, Link, Layout
├── jcf.rs          # Tech creator
├── emporium.rs     # Leather craftsperson
└── charlie.rs      # Adult content creator
#+end_example
...
├── home.rs        # Home page (realm routing)
├── auth.rs        # Auth/login page
├── join.rs        # Registration page
└── verify_email.rs # Email verification page
#+end_example
