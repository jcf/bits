...
fn get_easter_egg_message(handle: &str) -> Option<&'static str> {
    match handle {
        "god" => Some("Sorry, this handle is reserved for a higher power ✨"),
        "jesus" | "christ" => Some("This name is already taken by someone who walked on water 🌊"),
        "satan" | "devil" | "lucifer" => Some("Nice try, but we're keeping this one locked down 😈"),
        _ => None,
    }
}
#+end_src
