...
Create landing page for bits.page with interactive subdomain checker UI.

**Dependencies:** Requires features-and-organization.org complete (subdomain checker, page organization, demos)
...
#+begin_src rust
use crate::{check_subdomain, SubdomainStatus};
use dioxus::prelude::*;
...
* Update src/pages/home.rs

Replace Platform placeholder with Landing:

#+begin_src rust
use crate::{demos, tenant::Realm, pages::Landing};
...
- [ ] =cargo check= passes
- [ ] Visit =https://bits.page.test= shows landing
- [ ] Type "jcf" → shows "This is a demo profile"
- [ ] Type "god" → shows easter egg message
- [ ] Type "ab" → shows "Must be 3-63 characters"
- [ ] Type valid new name → shows "Available"
- [ ] Click "Reserve" → modal appears
- [ ] Modal email link has correct subject/body
- [ ] Prototype banner visible
- [ ] Debouncing works (doesn't check on every keystroke)

* Notes

- Test all easter eggs!
- Verify email link formatting
- Check responsive design on mobile
- Ensure Tailwind classes render correctly
