...
Available recipes:
    ...
    [serve]
    dev                             # Run Dioxus development server
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 JSON                      4           58           58            0            0
 Just                      2          578          346          119          113
 MDX                       1           56            0           39           17
 Nix                       9         1251          824          238          189
 Org                      16         2634         2331            4          299
 SQL                      10          339          269           33           37
 TOML                     12          330          289            1           40
 TypeScript                3           36           30            1            5
 YAML                      3         5053         3968            0         1085
─────────────────────────────────────────────────────────────────────────────────
 Markdown                  1          270            0          174           96
 |- Rust                   1          400          282           64           54
 (Total)                              670          282          238          150
─────────────────────────────────────────────────────────────────────────────────
 Rust                     96        16714        13838          903         1973
 |- Markdown              46          535            4          441           90
 (Total)                            17249        13842         1344         2063
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Total                   217        30380        23932         2166         4282
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

b2da6d4 @ 2025/12/12 19:30
#+end_example
...
| =DONE= | =2025-12-08= | [[file:.claude/prompts/20251208-pii-type-system.org][PII Type System]]                               |
...
| =DONE= | =2025-12-10= | [[file:.claude/prompts/20251210123457-tenant-resolution-architecture-simplification.org][Tenant Resolution Architecture Simplification]] |
| =DONE= | =2025-12-10= | [[file:.claude/prompts/20251210141817-add-claude-code-validation-hooks.org][Add Claude Code validation hooks]]              |
| =DONE= | =2025-12-12= | [[file:.claude/prompts/20251212184201-consolidate-bits-and-bits-app-crates.org][Consolidate bits and bits-app crates]]          |
...
#+results:
: crates/bits/src/auth/password.rs:// TODO Use #[patch] when Dioxus next ships
: crates/bits/src/config.rs:// TODO Wrap u32 in 'Limit' type.
: crates/bits/src/pages/layout.rs:    // TODO Make csrf_token a proper type akin to Option<String>.
: crates/bits/src/server.rs:// TODO Add health checks to core components within `AppState`.
