...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 JSON                      4           58           58            0            0
 Just                      2          429          246          101           82
 MDX                       1           56            0           39           17
 Nix                       8          779          463          222           94
 Org                      14         2507         2203            6          298
 SQL                       9          313          258           23           32
 TOML                     15          383          330            2           51
 TypeScript                3           36           30            1            5
 YAML                      3         5046         3963            0         1083
─────────────────────────────────────────────────────────────────────────────────
 Markdown                  1          144            0           97           47
 |- Rust                   1          173          124           27           22
 (Total)                              317          124          124           69
─────────────────────────────────────────────────────────────────────────────────
 Rust                     78        13370        11140          773         1457
 |- Markdown              23          217            0          202           15
 (Total)                            13587        11140          975         1472
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Total                   202        25697        20564         1642         3491
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

50e01c1-dirty @ 2025/12/05 15:36
#+end_example
...
fd --type file '\.org$' .claude/prompts | sort | while read -r file; do
  ...
  echo -e "=$status=\t=$date=\t[[file:$file][$title]]"
done
#+end_src

#+begin_src sh :results output verbatim
rg '^#\+status:' .claude/prompts/ </dev/null
#+end_src

#+results:
#+begin_example
.claude/prompts/20251204140400-production-deployment.org:#+status:   todo
.claude/prompts/20251206140000-refactor-bits-client.org:#+status:   todo
.claude/prompts/20251204140000-infrastructure-foundation.org:#+status:   todo
.claude/prompts/20251204140100-type-system-refactoring.org:#+status:   doing
.claude/prompts/20251205120511-handle-validation-improvements.org:#+status:   done
.claude/prompts/20251205174624-add-critical-unit-tests.org:#+status:   todo
.claude/prompts/20251205174626-improve-error-handling.org:#+status:   todo
.claude/prompts/20251206153200-add-garde-validation-library.org:#+status:   done
.claude/prompts/20251205174618-eliminate-boolean-parameters.org:#+status:   todo
.claude/prompts/20251204140300-landing-page-ui.org:#+status:   todo
.claude/prompts/20251205161600-replace-argon2-for-verification-codes.org:#+status:   done
.claude/prompts/20251205133111-nixos-deployment-cleanup.org:#+status:   done
.claude/prompts/20251205174622-remove-debug-statements.org:#+status:   todo
.claude/prompts/20251204140200-features-and-organization.org:#+status:   todo
.claude/prompts/20251205161500-complete-email-verification-enforcement.org:#+status:   doing
.claude/prompts/20251205174620-introduce-domain-newtypes.org:#+status:   todo
.claude/prompts/20251204182609-packer-nixos-image-for-hetzner.org:#+status:   todo
.claude/prompts/20251205160800-rate-limit-authentication-endpoints.org:#+status:   todo
#+end_example
