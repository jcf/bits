...
- Source-available - audit the code, modify what you need, contribute back
...
just setup  # First time: generates certs, builds container images
...
* License
Bits is source-available under the Business Source License 1.1 (BUSL-1.1) and
converts to the GNU Affero General Public License v3.0 or later four years
after each version's first public distribution. A commercial license is
available for organisations that cannot comply with BUSL.

See [[file:LICENSING.org][LICENSING.org]] for terms, rationale, and how to obtain a commercial
license.
